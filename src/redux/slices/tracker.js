...
export function getBoard() {
    return async () => {
        ...
        try {
            const response = await axios.get('/api/tracker/board');
...
export function createColumn(newColumn) {
    return async () => {
        dispatch(slice.actions.startLoading());
        try {
            const response = await axios.post('/api/tracker/columns/new', newColumn);
...
export function updateColumn(columnId, updateColumn) {
    return async () => {
        dispatch(slice.actions.startLoading());
        try {
            const response = await axios.post('/api/tracker/columns/update', {
                columnId,
                updateColumn
            });
...
export function deleteColumn(columnId) {
    return async () => {
        dispatch(slice.actions.startLoading());
        try {
            await axios.post('/api/tracker/columns/delete', { columnId });
