...
mock.onGet('/api/tracker/board').reply(200, { board });

// ----------------------------------------------------------------------

mock.onPost('/api/tracker/columns/new').reply((request) => {
    try {
...
mock.onPost('/api/tracker/columns/update').reply((request) => {
    try {
...
mock.onPost('/api/tracker/columns/delete').reply((request) => {
    try {
